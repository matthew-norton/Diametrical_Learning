...
This implementation can be customized to apply SGD-DRM to any network architecture (via pytorch) and loss function (see note in implementation details below). It also uses a fast multithreaded sampling scheme to make the gamma-neighborhood sampling steps of the algorithm more efficient.
